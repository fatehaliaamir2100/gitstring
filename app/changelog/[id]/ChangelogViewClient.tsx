        ...
        <div className="card">
          ...
          {activeTab === 'markdown' && (
            <div className="relative">
              <button
                ...
                className="absolute top-2 right-2 p-2 text-gray-600 hover:text-gray-900 bg-gray-100 hover:bg-gray-200 rounded"
              >
          ...
          {activeTab === 'json' && (
            <div className="relative">
              ...
              <pre className="bg-gray-50 p-6 rounded-lg overflow-x-auto text-sm">
                <code>{JSON.stringify(changelog.json_data, null, 2)}</code>
              </pre>
            </div>
          )}
        </div>
