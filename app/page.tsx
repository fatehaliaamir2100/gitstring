    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 pb-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
  ...
  - _by Jane Smith_`}
      ...
      <section id="features" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h3 className="text-3xl font-bold text-center mb-12 text-gray-900">Why GitString?</h3>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="card text-center">
              <div className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                <GitBranch className="w-6 h-6 text-primary-600" />
              </div>
              <h4 className="text-xl font-semibold mb-2 text-gray-900">Multi-Platform</h4>
            ...
            <div className="card text-center">
              ...
              <h4 className="text-xl font-semibold mb-2 text-gray-900">AI-Powered</h4>
              <p className="text-gray-600">
            ...
            <div className="card text-center">
              ...
              <h4 className="text-xl font-semibold mb-2 text-gray-900">Multiple Formats</h4>
              <p className="text-gray-600">
